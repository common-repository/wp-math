...
1) Fix the path to this and the images directory (see PARAMETERS TO MODIFY below)
...
function mathimage($text,$size,$pathtoimg,$alt)
{
/*
...
function mathfilter($text,$size,$pathtoimg,$alt=1) 
{
/* THE MAIN FUNCTION
...
foreach ($regs as $math) 
	...
	$t=str_replace('</m>','',$t);
	$code=mathimage(trim($t),$size,$pathtoimg,$alt);
